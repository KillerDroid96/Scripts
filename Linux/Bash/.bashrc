...
if [ -f $HOME/Github/Scripts/Linux/Bash/.bash_aliases ]; then
   source $HOME/Github/Scripts/Linux/Bash/.bash_aliases
fi

if [ -f $HOME/Github/Scripts/Linux/Bash/.bash_paths ]; then
   source $HOME/Github/Scripts/Linux/Bash/.bash_paths
fi
